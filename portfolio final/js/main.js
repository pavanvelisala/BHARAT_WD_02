...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("Perplex_007@about-me:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "experience":
      ...
      break;
    case "certificates":
      loopLines(certificates, "color2", 80);
      break;      
    case "resume":
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="santoshvardan007@gmail.com">santoshvardan007@Gmail.com</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function () {
